...
class KnowledgeBaseIndexer:
    def __init__(self, knowledge_base_path: str | None = None):
        """Инициализация индексера (берёт данные из Task5/knowledge_base)."""
    ...
    def load_documents(self) -> List[Document]:
        print("📚 Загрузка документов из Task5/knowledge_base...")
    ...
    def create_vector_index(self, persist_directory: str | None = None) -> Chroma:
        print("🔍 Создание векторного индекса (Task5/chroma_db)...")
...
def main():
    print("🚀 Запуск создания векторного индекса (Task5)")
    print("=" * 50)
    start = time.time()
    ...
    if not indexer.chunks:
        print("⚠️ Нет данных для индексации (0 чанков). Проверьте Task5/knowledge_base.")
        return
