...
def main():
    ...
    with col_info3:
        ...
        - **Точность**: Ответы основаны на реальных данных
        - **Актуальность**: Использует свежую информацию
        - **Прозрачность**: Показывает источники
        - **Гибкость**: Различные техники промптинга
        """)
